...
var map = {
	...
	"./employer/ads/create/step2/step2.module": [
		"./src/app/employer/ads/create/step2/step2.module.ts",
		"common",
		"employer-ads-create-step2-step2-module"
	],
	"./employer/ads/create/step3/step3.module": [
		"./src/app/employer/ads/create/step3/step3.module.ts",
		"employer-ads-create-step3-step3-module"
	],
	"./employer/notifications/notifications.module": [
		"./src/app/employer/notifications/notifications.module.ts",
		"employer-notifications-notifications-module"
	],
	"./employer/onboarding/onboarding.module": [
		"./src/app/employer/onboarding/onboarding.module.ts",
		"common",
		"employer-onboarding-onboarding-module"
	],
	"./employer/profile/details/details.module": [
		"./src/app/employer/profile/details/details.module.ts",
		"common",
		"employer-profile-details-details-module"
	],
	"./employer/profile/payment-methods/payment-methods.module": [
		"./src/app/employer/profile/payment-methods/payment-methods.module.ts",
		"employer-profile-payment-methods-payment-methods-module"
	],
	"./employer/profile/profile.module": [
		"./src/app/employer/profile/profile.module.ts",
		"default~employer-profile-profile-module~start-login-login-module~start-login-password-reset-password~9da45a3c",
		"common",
		"employer-profile-profile-module"
	],
	"./start/login/login.module": [
		"./src/app/start/login/login.module.ts",
		"default~employer-profile-profile-module~start-login-login-module~start-login-password-reset-password~9da45a3c",
		"common",
		"start-login-login-module"
	],
	"./start/login/password-reset/password-reset.module": [
		"./src/app/start/login/password-reset/password-reset.module.ts",
		"default~employer-profile-profile-module~start-login-login-module~start-login-password-reset-password~9da45a3c",
		"common",
		"start-login-password-reset-password-reset-module"
	],
	"./start/register/register.module": [
...
var environment = {
    production: false,
    firebase: {
        apiKey: 'AIzaSyAZpmP_jwDaRSE5p_xDm_9CkSI6LzRLeUU',
        authDomain: 'medapp-e3698.firebaseapp.com',
        databaseURL: 'https://medapp-e3698.firebaseio.com',
        projectId: 'medapp-e3698',
        storageBucket: 'medapp-e3698.appspot.com',
        messagingSenderId: '65204106530',
        appId: '1:65204106530:web:617e3a9bb94a2cc8'
    }
};
/*
...
module.exports = __webpack_require__(/*! D:\KodeAlpha\Workspace\Projects\DAHMS\Test\DAHMS 1.0\src\main.ts */"./src/main.ts");
