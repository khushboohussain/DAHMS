...
var ApiService = /** @class */ (function () {
    ...
    /* Creating New User  */
    ApiService.prototype.createUser = function (id, data) {
    ...
    // }
    ApiService.prototype.getAllEmployer = function () {
        return this.afs.collection('employer').snapshotChanges();
    };
    ApiService.prototype.createEmployer = function (id, data) {
        return this.afs.doc('employer/' + id).set(data);
    };
    ApiService.prototype.getEmployerData = function (id) {
        return this.afs.doc('employer/' + id).valueChanges();
    };
    ApiService.prototype.updateEmployerData = function (id, data) {
        return this.afs.doc('employer/' + id).update(data);
    };
    ApiService.prototype.deleteEmployer = function (id) {
    ...
    // }
    ApiService.prototype.createEmployee = function (id, data) {
    ...
    ApiService.prototype.getEmployeeData = function (id) {
    ...
    // Job or Ads
    ApiService.prototype.createAds = function (data) {
        return this.afs.collection('ads').add(data);
    };
    ApiService.prototype.getAd = function (id) {
        return this.afs.doc('ads/' + id).valueChanges();
    };
    ApiService.prototype.getAllAds = function () {
        return this.afs.collection('ads').snapshotChanges();
    };
    ApiService.prototype.updateAds = function (id, data) {
        return this.afs.doc('ads/' + id).update(data);
    };
    ApiService.prototype.deleteAds = function (id) {
        return this.afs.doc('ads/' + id).delete();
    };
    ApiService.prototype.getEmployeerAds = function (id) {
        return this.afs.collection('ads', function (ref) { return ref.where('uid', '==', id); }).snapshotChanges();
    };
...
var HelperService = /** @class */ (function () {
    function HelperService(toastController) {
        this.toastController = toastController;
    }
    HelperService.prototype.presentToast = function (MSG) {
...
var LocationService = /** @class */ (function () {
    function LocationService(ngzone) {
        this.ngzone = ngzone;
        this.service = new google.maps.places.AutocompleteService();
    }
    LocationService.prototype.addressChooseItem = function (item) {
        // this.modalCtrl.dismiss(item);
        this.geo = item;
        this.addressGeoCode(this.geo); // convert Address to lat and long
    };
    // convert Address string to lat and long
    LocationService.prototype.addressGeoCode = function (address) {
        var _this = this;
        ...
        geocoder.geocode({ 'address': address }, function (results, status) {
            ...
            console.log('pickup : ', _this.company);
        });
    };
    LocationService.prototype.addressUpdateSearch = function () {
