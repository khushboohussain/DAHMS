...
var Step1Page = /** @class */ (function () {
    ...
    function Step1Page(actionSheetController, navController, fb, helper, location) {
        ...
        this.maxDate = new Date(this.nowDate.getFullYear() + 2, 11, 31).toISOString().slice(0, 10);
    ...
    // }
    Step1Page.prototype.getLocations = function () {
        this.location.addressUpdateSearch();
    };
    Step1Page.prototype.addressItem = function (item) {
        this.disableaddress = true;
    ...
    Step1Page.prototype.pickupBlur = function () {
        if (this.location.addressAutocomplete.query.length === 0) {
            this.disableaddress = true;
        }
    };
    Step1Page.prototype.pickupFocus = function () {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        localStorage.setItem('actionController', JSON.stringify(true));
                                        localStorage.setItem('continuoueCheck', JSON.stringify(_this.continuoueCheck));
    ...
    Object.defineProperty(Step1Page.prototype, "f", {
        get: function () {
    ...
    Step1Page.prototype.gettingDate = function (event) {
        var _this = this;
        if (event.value.startDate !== '') {
            ...
            if (event.value.startDate < this.today) {
                ...
                var startDateX = event.value.startDate.split('-');
        ...
        if (event.value.endDate !== '') {
            ...
            if (event.value.endDate < this.today) {
                ...
                var endDate = event.value.endDate.split('-');
        ...
        if (event.value.startDate !== '' && event.value.endDate !== '') {
            if (event.value.startDate > event.value.endDate) {
                ...
                if (moment__WEBPACK_IMPORTED_MODULE_1__(event.value.startDate).format('LL') === moment__WEBPACK_IMPORTED_MODULE_1__(event.value.endDate).format('LL')) {
                    ...
                    var DifferenceOfDate = moment__WEBPACK_IMPORTED_MODULE_1__(event.value.endDate).diff(moment__WEBPACK_IMPORTED_MODULE_1__(event.value.startDate), 'days');
                    ...
                    if (DifferenceOfDate === 1) {
                        ...
                        this.form.get('continoueWork').valueChanges.subscribe(function (res) {
                            _this.continuoueCheck = res;
                            // this.differDates = true;
                        });
                    }
...
module.exports = ".box ion-item {\n  --padding-start: 0;\n  --background: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
